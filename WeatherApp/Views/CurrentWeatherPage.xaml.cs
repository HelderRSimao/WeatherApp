...
namespace CompleteWeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        private string Location { get; set; } = "Lisbon";
        ...
        private async void GetBackGround()
        {
            ...
            var result = await ApiCaller.Get(url, "U81kUrzpEDzhRRs9TKmvII1ar10a7GUFoKS0IErCyi2PzKmpE1FSethU");
        ...
        {
            var url = $"https://api.openweathermap.org/data/2.5/weather?q={Location}&appid=db3213f86f02b34bcc79b1841c8faeda&units=metric";
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=db3213f86f02b34bcc79b1841c8faeda&units=metric";
            var result = await ApiCaller.Get(url);
